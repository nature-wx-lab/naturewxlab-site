...
def main() -> int:
    ...
    social_preview_source = SITE_ROOT / "assets/images/og-image-20260722-v3.svg"
    if social_preview_source.is_file():
        social_preview_svg = social_preview_source.read_text(encoding="utf-8")
        for required_text in (
            ">NATURE × WEATHER × LIFE</text>",
            ">気象予報士パパの自然研究所</text>",
            ">NatureWxLab</text>",
            ">天気を味方に、自然と暮らす</text>",
            ">naturewxlab.com</text>",
        ):
            if social_preview_svg.count(required_text) != 1:
                errors.append(f"social preview source must contain exactly one {required_text!r}")
    ...
    expected_about_copy = (
        ...
        "Codex、ClaudeなどのAIを協働相手として活用しています。",
        "人が責任を持って確認しながら形にします。",
    ...
    expected_vision_fragments = (
        ...
        '<p>NatureWxLabの現在の中心は、天気と自然を結ぶ無料の公開ツール、noteの記事、<br>Xでの日々の発信、'
        ...
        '<p>現在できていることと、これから実現したいことを分けて伝えます。安全性、わかりやすさ、<br>'
    ...
    expected_roadmap_items = (
        ...
        '人と自然、人と人が直接出会い、<br>学びや体験を共有できる機会を少しずつ増やしていきます。</p>'
        ...
        '園芸、農業、メダカ飼育、<br>天気、自然観察など、<strong>「自然」への関心を共通点に、'
